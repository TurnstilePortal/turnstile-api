...
export class TokenService {
  ...
  async getTokens(cursor: number, limit: number) {
  ...
  async getTokenByAddress(normalizedAddress: string) {
    return this.db
      .select()
      .from(tokens)
  ...
  async getProposedTokens(cursor: number, limit: number) {
  ...
  async getRejectedTokens(cursor: number, limit: number) {
  ...
  async getAcceptedTokens(cursor: number, limit: number) {
  ...
  async getBridgedTokens(cursor: number, limit: number) {
